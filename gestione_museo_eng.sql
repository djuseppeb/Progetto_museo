...
--
-- Host: 127.0.0.1
-- Creato il: Dic 09, 2020 alle 11:56
...
CREATE TABLE `art_piece` (
  ...
  `Availability` set('Disponibile','In restauro','Venduto') NOT NULL,
...
INSERT INTO `art_piece` (`ID_art`, `Title`, `Artist`, `Availability`, `Type`, `Room`, `Art_movement`, `Description`, `Position`, `Value_Euro`) VALUES
(1, 'Gioconda o Monna Lisa', 'Leonardo Da Vinci', 'Disponibile', 'Quadro', 1, 'Arte rinascimentale', 'Opera iconica ed enigmatica della pittura mondiale, si tratta sicuramente del ritratto più celebre della storia nonché di una delle opere d\'arte più note in assoluto. Il sorriso impercettibile del soggetto, col suo alone di mistero, ha ispirato tantissime pagine di critica, letteratura, opere di immaginazione e persino studi psicoanalitici; sfuggente, ironica e sensuale, la Monna Lisa è stata di volta in volta amata e idolatrata, ma anche derisa o aggredita.', 1, 100000),
(2, 'Ultima Cena', 'Leonardo Da Vinci', 'In restauro', 'Quadro', 1, 'Arte rinascimentale', 'Si tratta della più celebre rappresentazione dell\'Ultima Cena, capolavoro di Leonardo e del Rinascimento italiano in generale. Nonostante ciò, l\'opera - a causa della singolare tecnica sperimentale utilizzata da Leonardo, incompatibile con l\'umidità dell\'ambiente - versa da secoli in un cattivo stato di conservazione, cui si è fatto fronte, per quanto possibile, nel corso di uno dei più lunghi restauri della storia, durato dal 1978 al 1999 con le tecniche più all\'avanguardia del settore', 2, 75000),
