...
--
-- Host: 127.0.0.1
-- Creato il: Gen 08, 2021 alle 18:40
...
(1, 'Gioconda', 'Leonardo Da Vinci', 'Disponibile', 'Quadro', 1, 'Arte rinascimentale', 'Opera iconica ed enigmatica della pittura mondiale, si tratta sicuramente del ritratto più celebre della storia nonché di una delle opere d\'arte più note in assoluto. Il sorriso impercettibile del soggetto, col suo alone di mistero, ha ispirato tantissime pagine di critica, letteratura, opere di immaginazione e persino studi psicoanalitici; sfuggente, ironica e sensuale, la Monna Lisa è stata di volta in volta amata e idolatrata, ma anche derisa o aggredita.', 1, 100000, 'https://www.analisidellopera.it/wp-content/uploads/2018/01/Leonardo_Monna_Lisa_Gioconda-687x1024.jpg'),
